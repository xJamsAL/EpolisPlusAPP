...
class DopUslugiAdapter(
    private var dopItems: List<DopItems>,
    private val currencyResId: Int,
    private val context: Context,
    private var discountPercent: Int,
    private var discountLength: Int,
    private val onSelectionChanged: (Int, Int) -> Unit,
    private val onItemClick: (DopItems) -> Unit
) : RecyclerView.Adapter<DopUslugiAdapter.DopUslugiViewHolder>() {
    ...
    fun updateData(newDopList: List<DopItems>, newDiscountPercent: Int, newDiscountLength: Int) {
        dopItems = newDopList
